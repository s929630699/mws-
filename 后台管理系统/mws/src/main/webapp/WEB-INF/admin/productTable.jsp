		...
		<div class="layuimini-main">
			...
			<div class="layui-form layui-border-box layui-table-view"
				...
				<div class="layui-table-box">
						...
						<table cellspacing="0" cellpadding="0" border="0"
							...
							<thead>
								<tr>
									...
									<th data-field="louhao" data-key="1-0-3"
									...
									<th data-field="fanghao" data-key="1-0-4"
										class=" layui-unselect"><div
									...
									<th data-field="xueyuan" data-key="1-0-5"
										class=" layui-unselect"><div
									...
									<th data-field="niandu" data-key="1-0-8"
										class=" layui-unselect"><div
					...
					<div class="layui-table-body layui-table-main" style="overflow:hidden;white-space:normal;word-break:break-all;">
						<table cellspacing="0" cellpadding="0" border="0"
							class="layui-table" lay-skin="line">
							<tbody>
