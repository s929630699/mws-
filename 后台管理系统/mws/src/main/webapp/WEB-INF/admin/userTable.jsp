		...
		<div class="layuimini-main">
			...
			<fieldset class="table-search-fieldset">
				...
				<div style="margin: 10px 10px 10px 10px">
					<form action="${pageContext.request.contextPath }/user/list2.action" method="get">
			...
			<div class="layui-form layui-border-box layui-table-view"
							...
							<thead>
								<tr>
									...
									<th data-field="name" data-key="1-0-2" class=" layui-unselect"><div
											...
											<span>用户名</span><span class="layui-table-sort layui-inline"><i
												class="layui-edge layui-table-sort-asc" title="升序"></i><i
												class="layui-edge layui-table-sort-desc" title="降序"></i></span>
										</div></th>
									<th data-field="price" data-key="1-0-3"
										class=" layui-unselect"><div
											...
											<span>密码</span><span class="layui-table-sort layui-inline"><i
												class="layui-edge layui-table-sort-asc" title="升序"></i><i
												class="layui-edge layui-table-sort-desc" title="降序"></i></span>
										</div></th>
									...
									<th data-field="pnum" data-key="1-0-5"
										class=" layui-unselect"><div
											...
											<span>电话</span><span class="layui-table-sort layui-inline"><i
												class="layui-edge layui-table-sort-asc" title="升序"></i><i
												class="layui-edge layui-table-sort-desc" title="降序"></i></span>
										</div></th>
									<th data-field="imgurl" data-key="1-0-6" class=" layui-unselect"><div
											class="layui-table-cell laytable-cell-1-0-6">
											<span>介绍</span><span class="layui-table-sort layui-inline"><i
												class="layui-edge layui-table-sort-asc" title="升序"></i><i
												class="layui-edge layui-table-sort-desc" title="降序"></i></span>
										</div></th>
									<th data-field="description" data-key="1-0-7"
										class=" layui-unselect"><div
											...
											<span>身份</span><span class="layui-table-sort layui-inline"><i
												class="layui-edge layui-table-sort-asc" title="升序"></i><i
												class="layui-edge layui-table-sort-desc" title="降序"></i></span>
										</div></th>
									<th data-field="manufactureDate" data-key="1-0-8"
										class=" layui-unselect"><div
											...
											<span>注册时间</span><span class="layui-table-sort layui-inline"><i
												class="layui-edge layui-table-sort-asc" title="升序"></i><i
												class="layui-edge layui-table-sort-desc" title="降序"></i></span>
										</div></th>
									<th data-field="5" data-key="1-0-10" data-minwidth="150"
								...
								<c:forEach items="${users}" var="u">
									<tr data-index="0" class="">
										<td data-field="id" data-key="1-0-1" class=""><div
												class="layui-table-cell laytable-cell-1-0-1">${u.id}</div></td>
										<td data-field="name" data-key="1-0-2" class=""><div
												class="layui-table-cell laytable-cell-1-0-2">${u.username}</div></td>
										<td data-field="price" data-key="1-0-3" class=""><div
												class="layui-table-cell laytable-cell-1-0-3">${u.password}</div></td>
										<td data-field="category" data-key="1-0-4" class=""><div
												class="layui-table-cell laytable-cell-1-0-4">${u.gender}</div></td>
										<td data-field="pnum" data-key="1-0-5" class=""><div
												class="layui-table-cell laytable-cell-1-0-5">${u.telephone}</div></td>
										<td data-field="imgurl" data-key="1-0-6" class=""><div
												class="layui-table-cell laytable-cell-1-0-6">${u.introduce}</div></td>
										<td data-field="description" data-key="1-0-7" class=""><div
												class="layui-table-cell laytable-cell-1-0-7">${u.role}</div></td>
										<td data-field="manufactureDate" data-key="1-0-8" class=""><div
												class="layui-table-cell laytable-cell-1-0-8">${u.registTime}</div></td>
										<td data-field="6" data-key="1-0-10" align="center"
											...
											class="layui-table-col-special"><div
												...
												<a
													...
													lay-event="edit" 
													href="${pageContext.request.contextPath }/user/update.action?id=${u.id}">编辑</a>
												<a
													class="layui-btn layui-btn-xs layui-btn-danger data-count-delete"
													lay-event="delete"
													href="${pageContext.request.contextPath }/user/delete.action?id=${u.id}">删除</a>
											</div></td>
									</tr>
								</c:forEach>
							</tbody>
				...
				<form action="${pageContext.request.contextPath }/user/jumpPage.action">
						...
						<c:choose>
							...
							<c:when test="${paging.currentPage==paging.totalPage}">
								<a class="layui-btn layui-btn-xs"
									...
									href="${pageContext.request.contextPath }/user/homePage.action">首页</a>
								<a class="layui-btn layui-btn-xs"
									style="width: 70px; height: 25px; font-size: 15px;"
									href="${pageContext.request.contextPath }/user/upPage.action">上一页</a>
							</c:when>
							<c:when test="${paging.currentPage==1 }">
								<a class="layui-btn layui-btn-xs"
									style="width: 70px; height: 25px; font-size: 15px;"
									href="${pageContext.request.contextPath }/user/downPage.action">下一页</a>
								<a class="layui-btn layui-btn-xs"
									style="width: 50px; height: 25px; font-size: 15px;"
									href="${pageContext.request.contextPath }/user/lastPage.action">末页</a>
							</c:when>
							<c:when test="${paging.currentPage==paging.totalPage }">
								<a class="layui-btn layui-btn-xs"
									style="width: 50px; height: 25px; font-size: 15px;"
