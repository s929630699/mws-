...
<head>
    ...
    <style>
        ...
        .admin-login-background {width:380px;height:300px;position:absolute;left:50%;top:40%;margin-left:-180px;margin-top:-100px;}
        ...
        <div class="layui-form login-form">
            <form class="layui-form" action="">
                ...
                <div class="layui-form-item">
                    ...
                    <input type="text" name="captcha" lay-verify="required|captcha" placeholder="验证码" autocomplete="off" class="layui-input verification captcha" value="xszg">
                    <div class="captcha-img">
                        <img id="captchaPic" src="img/captcha.jpg">
                    </div>
                </div>
                <div class="layui-form-item">
